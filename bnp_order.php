    ...
    echo '        
      ...
      <body class="center margin-left margin-top" style="color:#444;font-size:10px" >
        ...
        <form action="cust.php" class="padding-16 row-padding " method="POST" target="_self">
          <input class="message input  border "  name="a" style="border-radius:40px;color:black;width:80%;" type="text" placeholder="Name..." /><br>

          <input class=" message input  border  half padding "   name="b" style=" border-radius:40px;width:37%;" type="phone" placeholder="Phone No...." />
            
          <input class="message input  half  border margin-left padding" style="border-radius:40px;width:40%;" type="phone" placeholder="Whatsapp No. ..."  name="c"/><br><br>

          <input class="message input border margin-top " style="border-radius:40px;width:80%;" type="email" placeholder="Email..."  name="d"/><br>

          <textarea class="message input round border " style="width:80%;height:80px;" type="text" placeholder="Address..."  name="e"></textarea><br>
